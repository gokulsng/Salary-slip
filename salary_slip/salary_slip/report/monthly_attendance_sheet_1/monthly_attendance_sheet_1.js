...
frappe.query_reports["Monthly Attendance Sheet 1"] = {
	"filters": [
		{
			"fieldname": "month",
			"label": __("Month"),
	...
	onload: function() {
		return  frappe.call({
			method: "salary_slip.salary_slip.report.monthly_attendance_sheet_1.monthly_attendance_sheet_1.get_attendance_years",
			callback: function(r) {
